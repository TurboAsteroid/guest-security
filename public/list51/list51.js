'use strict';
angular.module('list51Controller', ['ngRoute'])

    .controller('list51Controller', function ($scope, $http, $interval, $mdDialog, $mdMedia, $rootScope, $location, $window, CardN, Doknr, User, GiveProp) {
        ...
        $scope.showAdvanced = function(ev, doknr) {
            ...
            Doknr.update(doknr);
            $mdDialog.show({
                    controller: DialogController51,
                    templateUrl: 'list51/advanced51.html',
...
function DialogController51($scope, $mdDialog, $http, $window, Doknr, User) {
    $scope.$watch(function(){
        return $window.innerWidth;
    }, function(value) {
        if(value < 1130) {
