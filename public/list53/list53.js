'use strict';
angular.module('list53Controller', ['ngRoute'])

    .controller('list53Controller', function ($scope, $http, $interval, $mdDialog, $mdMedia, $rootScope, $location, $window, CardN, Doknr, User, GiveProp) {
        ...
        $scope.showAdvanced = function(ev, doknr) {
            ...
            Doknr.update(doknr);
            $mdDialog.show({
                    controller: DialogController53,
                    templateUrl: 'list53/advanced53.html',
    ...
    function DialogController53($scope, $mdDialog, $http, $window, Doknr, User) {
        $scope.$watch(function(){
            return $window.innerWidth;
        }, function(value) {
            if(value < 1130) {
